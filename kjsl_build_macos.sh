...
deps () {
  brew install glib gettext bison gobject-introspection graphene libogg libvorbis opus orc theora pango meson ninja pkg-config gnu-indent gtk-doc xquartz
}
